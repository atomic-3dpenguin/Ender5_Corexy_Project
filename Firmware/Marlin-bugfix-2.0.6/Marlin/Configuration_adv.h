 ...
 */
  ...
  #if AXIS_IS_TMC(X)                           //-AP- Updated for Ender 5
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       X_CURRENT       //-AP- Updated for Ender5 Corexy
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       758       //-AP- Updated for Ender 5
